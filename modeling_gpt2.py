"""PyTorch OpenAI GPT-2 model modifications according to nGPT specifications"""
...
class GPT2LMHeadModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.lm_head = nn.Linear(config.n_embd, config.vocab_size, bias=False) # this line is now completely useless. lm_head will not be used anywhere
